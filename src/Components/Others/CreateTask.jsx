...
const CreateTask = () => {
  return (
    <div className="p-5 bg-[#1c1c1c] mt-7 rounded">
        <form className="flex w-full items-start justify-between m-5">
          <div className="w-1/2">
            <div>
          ...
          <div className="w-2/5 flex-col items-start">
              ...
              <textarea className="w-full h-4/5 text-sm py-1 px-2 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4" name="" id=""></textarea>
